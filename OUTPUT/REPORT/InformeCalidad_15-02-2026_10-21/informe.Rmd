...
resumen_consola$Cycle <- as.numeric(as.character(resumen_consola$Cycle))
resumen_consola$mean_score <- as.numeric(as.character(resumen_consola$mean_score))
