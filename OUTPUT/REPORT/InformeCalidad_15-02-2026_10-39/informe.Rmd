...
qual_summary$Cycle <- as.numeric(as.character(resumen_consola$Cycle))
qual_summary$mean_score <- as.numeric(as.character(resumen_consola$mean_score))
