...
Además, encontré un pipeline R que utiliza este paquete para a partir de datos 16S, asignar taxones con una base de datos de referencia, pasando por todo el proceso de filtrado, etc.
...
-   trimTaiklw()
-   width()
Estas permiten eliminar o filtrar lecturas en función de características como la presencia de N, la calidad o la longitud de las secuencias. Existe un flujo de trabajo 
